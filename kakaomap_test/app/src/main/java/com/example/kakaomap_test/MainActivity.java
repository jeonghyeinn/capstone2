...
//        mapView.setMapCenterPoint(MapPoint.mapPointWithGeoCoord(35.178325,126.909446), true);
//
        mapView.setZoomLevel(2,true);
        mapView.zoomIn(true);
        mapView.zoomOut(true);

        MapPoint MARKER_POINT = MapPoint.mapPointWithGeoCoord(35.178325,126.909446);

        MapPOIItem marker = new MapPOIItem();
        marker.setItemName("전남대 공7");
        marker.setTag(0);
